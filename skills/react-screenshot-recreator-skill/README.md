...
<h1>📸&nbsp;&nbsp;React Screenshot Recreator</h1>

<p><b>Paste a screenshot. Get React + TypeScript + Tailwind that a designer can't tell apart.</b></p>
...
```bash
npx github:AnshumanSakhare/agent-skills add react-screenshot-recreator-skill
```
